...
$includedNames = (Get-ChildItem $CommandPath -Recurse -File -Filter *.ps1 ).BaseName
Import-Module $PSSCriptroot\..\src\$ModuleName`.psd1 -Force
...
foreach ($command in $commands)
{
    ...
    $HelpUri = "https://gitscm.cisco.com/projects/DSAUT/repos/$modulename/browse/docs/$commandName"
